    ...
    <div class="card-body">
        <form action="{{ route('categories.store') }}" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="name" id="category_name" class="form-control {{ $errors->has('name') ? 'is-invalid' : ''}}" value="{{ old('name') }}" required>
                    @error('name')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="checkbox" name="is_parent" value="1" id="is_parent" {{ old('parent_category_id') ? '' : 'checked' }}> Yes
                </div>
            </div>
            <div id="parent_div" class="form-group row d-none">
                <label for="parent_category" class="col-sm-2">Parent Category:</label>
                <div class="col-sm-8">
                    <select name="parent_category_id" id="parent_category" class="form-control {{ $errors->has('name') ? 'is-invalid' : ''}}">
